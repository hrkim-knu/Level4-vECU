    ...
    public abstract class TimeSourceBase : IdentifiableObject, ITimeSource, IDisposable
    {
        ...
        private void SynchronizeVirtualTime()
        {
            lock(virtualTimeSyncLock)
            {
                ...
                // hrkim
                // Console.WriteLine($"Entering SynchronizeVirtualTime timeDiff : {timeDiff}");
                UpdateTime(timeDiff);
        ...
        private void UpdateTime(TimeInterval virtualTimeElapsed)
        {
            lock(hostTicksElapsed)
            {
                ...
                // hrkim
                // Console.WriteLine($"Update Time : {virtualTimeElapsed.TotalMicroseconds} us");
                // Console.WriteLine($"Current Timestamp: {currentTimestamp.TotalMicroseconds} us");
                // Console.WriteLine($"Elapsed This Time: {elapsedThisTime.TotalMicroseconds} us");
